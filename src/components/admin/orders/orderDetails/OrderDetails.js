...
const OrderDetails = () => {
  ...
  const { data, error, isLoading } = useGetOneOrderQuery(parseInt(param));
  ...
  useEffect(() => {
    if (data) {
      ...
      setStatus(data.data.order_states.title);
            ...
            <>
              ...
              {adresses.map((ad, index) => {
                ...
                return (
                  <div key={index}>
                    <p>
                      <b>{capitalise(adress_types.title)} address:</b>
                    </p>
                    <p>{entitled}</p>
              ...
              <table>
                ...
                <tbody>
                  {products.map((prod) => {
                    const { product, priceHT, TVA_title, quantity, TVA_value } =
                      prod;
