...
import { CALCULATE_CART_TOTAL, DECREASE_PRODUCT, DELETE_CART, DELETE_PRODUCT, INCREASE_PRODUCT, SAVE_URL, selectCartItem, selectProducts } from '../../redux/slices/cartSlice';
                                    ...
                                    <tr key={index}>
                                        ...
                                        <td>
                                            <div className={styles.count}>
                                                <button className='--btn' onClick={() => decreaseCart(product_id, priceHT)}>-</button>
                                                <p><b>{quantity}</b></p>
                                                <button className='--btn' onClick={() => increaseCart(product_id, priceHT)}>+</button>
                                            </div>
                                        </td>
                                        <td>{totalTTC}</td>
                                        <td className={styles.icons}>
                                            <FaTrashAlt size={15} color={'#257781'} onClick={() => deleteProduct(product_id)}/>
                                        </td>
                                    </tr>
                                )
                            })}
