...
const CheckoutDetails = () => {
  ...
  const { data } = useGetAllAdressesByUserQuery(parseInt(user.id));
  ...
  const handleCheckout = (e) => {
    ...
    if (billingAdress === null || shippingAdress === null)
      toast.error("Please choose adresses");
    else {
      dispatch(
        SET_ADRESSES({
                    ...
                    <div key={ad.id}>
                      <Card cardClass={styles.adress}>
                        <input
                          ...
                          value={ad.id}
                          id={ad.id}
                          onChange={(e) => handleShipping(e, ad)}
                        />
                        <label htmlFor={ad.id} className={styles.label}>
                          ...
                          <p>
                            {ad.number} {ad.number_complement} {ad.street}
                          </p>
                          <p>
