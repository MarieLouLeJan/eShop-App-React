...
import { useGetOneProductShopQuery, useGetReviewByProductQuery } from '../../../redux/api/shopApi'
                        ...
                        <div className={styles.details}>
                            ...
                            <div className={styles.content}>
                                ...
                                <div className={styles.count}>
                                    <button className='--btn' onClick={() => changeQuantity('-')}>-</button>
                                    <p>
                                        <b>{quantity}</b>
                                    </p>
                                    <button className='--btn' onClick={() => changeQuantity('+')}>+</button>
                                ...
                                {reviews.map((review, index) => {
                                    ...
                                    return (
                                        <div key={index} className={styles.review}>
                                            ...
                                            <p>{content}</p>
                                            <br />
                                            <span><b>By: </b> {user.firstname}</span>
                                        </div>
                                    )
                                })}
                            </>
