...
import { useCreateProductReviewMutation, useGetOneProductShopQuery } from '../../redux/api/shopApi';
...
const ReviewProduct = () => {
  ...
  const [ addReview, { isLoading: addIsLoading } ] = useCreateProductReviewMutation()
